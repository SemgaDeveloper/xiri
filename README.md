...
4.Go and configure resolution, windows width and height, keyboard layouts, wallpaper in xiri.cpp (i still haven't made config file, but i think i will add it later)  
5.Save changes  
